...
function colormag_add_custom_box() {
	...
	add_meta_box( 'page-layout', __( 'Select Layout', 'colormag-pro' ), 'colormag_page_layout', 'page', 'side', 'default' );
	// Adding layout meta box for
	add_meta_box( 'page-layout', __( 'Select Layout', 'colormag-pro' ), 'colormag_page_layout', 'post', 'side', 'default' );
}
...
$page_layout = array(
							'default-layout' 	=> array(
														...
														'label' 		=> __( 'Default Layout', 'colormag-pro' )
														),
							'right-sidebar' 	=> array(
														'id'			=> 'colormag_page_layout',
														'value' 		=> 'right_sidebar',
														'label' 		=> __( 'Right Sidebar', 'colormag-pro' )
														),
							'left-sidebar' 	=> array(
														'id'			=> 'colormag_page_layout',
														'value' 		=> 'left_sidebar',
														'label' 		=> __( 'Left Sidebar', 'colormag-pro' )
														),
							'no-sidebar-full-width' => array(
															'id'			=> 'colormag_page_layout',
															'value' 		=> 'no_sidebar_full_width',
															'label' 		=> __( 'No Sidebar Full Width', 'colormag-pro' )
															),
							'no-sidebar-content-centered' => array(
															'id'			=> 'colormag_page_layout',
															'value' 		=> 'no_sidebar_content_centered',
															'label' 		=> __( 'No Sidebar Content Centered', 'colormag-pro' )
															)
						);
