<?php
/**
 * WooCommerce Ad-Free License System for ExtraChill Theme
 * 
 * Allows users to purchase a license via WooCommerce to remove ads from the site
 * for a given community username. Integrates with the community system.
 * 
 * @package ExtraChill
 * @since 1.0
 */
...
/**
 * Add community username field to the ad-free product page
 */
...
/**
 * Auto-complete ad-free orders (digital product)
 */
...
/**
 * Save username to cart when adding ad-free product
 */
...
/**
 * Add username metadata to order item
 */
...
/**
 * Add username input field in cart for ad-free product
 */
...
/**
 * Save username when cart is updated
 */
...
/**
 * Validate username is provided before checkout
 */
