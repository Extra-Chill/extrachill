...
class colormag_125x125_advertisement_widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops  = array(
			...
			'description'                 => __( 'Add your 125x125 Advertisement here', 'colormag-pro' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: 125x125 Advertisement', 'colormag-pro' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<label><?php _e( 'Add your Advertisement 125x125 Images Here', 'colormag-pro' ); ?></label>
		<?php
		for ( $i = 1; $i < 7; $i ++ ) {
			$image_link = '125x125_image_link_' . $i;
			$image_url  = '125x125_image_url_' . $i;
			...
			<p>
				<label for="<?php echo $this->get_field_id( $image_link ); ?>"> <?php
					_e( 'Advertisement Image Link ', 'colormag-pro' );
					echo $i;
					?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( $image_url ); ?>"> <?php
					_e( 'Advertisement Image ', 'colormag-pro' );
					echo $i;
					?></label>
