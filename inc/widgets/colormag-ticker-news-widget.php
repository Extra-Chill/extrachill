...
class colormag_ticker_news_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( false, $name = __( 'TG: Featured Posts (Style 7)', 'colormag-pro' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<div style="text-align: center;"><img src="<?php echo esc_url(get_template_directory_uri() . '/img/style-7.jpg' ) ?>">
		</div>
		<p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'popup' ); ?>"><?php _e( 'Check to display the content in the popup', 'colormag-pro' ); ?></label>
		</p>
