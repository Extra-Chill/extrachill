...
class colormag_300x250_advertisement_widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops  = array(
			...
			'description'                 => __( 'Add your 300x250 Advertisement here', 'colormag-pro' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: 300x250 Advertisement', 'colormag-pro' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<label><?php _e( 'Add your Advertisement 300x250 Images Here', 'colormag-pro' ); ?></label>
		<p>
			<label for="<?php echo $this->get_field_id( $image_link ); ?>"> <?php _e( 'Advertisement Image Link ', 'colormag-pro' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( $image_url ); ?>"> <?php _e( 'Advertisement Image ', 'colormag-pro' ); ?></label>
		<div class="media-uploader" id="<?php echo $this->get_field_id( $image_url ); ?>">
			...
			<button class="custom_media_upload button button-secondary button-large" id="<?php echo $this->get_field_id( $image_url ); ?>" data-choose="<?php esc_attr_e( 'Choose an image', 'colormag-pro' ); ?>" data-update="<?php esc_attr_e( 'Use image', 'colormag-pro' ); ?>" style="width:100%;margin-top:6px;margin-right:30px;"><?php esc_html_e( 'Select an Image', 'colormag-pro' ); ?></button>
		</div>
		</p>
