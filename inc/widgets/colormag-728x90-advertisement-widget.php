...
class colormag_728x90_advertisement_widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops  = array(
			...
			'description'                 => __( 'Add your 728x90 Advertisement here', 'colormag-pro' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: 728x90 Advertisement', 'colormag-pro' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<label><?php _e( 'Add your Advertisement 728x90 Images Here', 'colormag-pro' ); ?></label>
		<p>
