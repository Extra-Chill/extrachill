...
### Changed
- replace dynamic design-system route with static generated page
...
### Fixed
- emit fully-formed font families with slugs in theme.json filter
...
### Fixed
- invert :has() grid so default is single-column
...
### Fixed
- restore structural borders for block editor shell after IBE migration

## [2.4.3] - 2026-05-25

### Fixed
- modernize block-editor toolbar selectors for current Gutenberg DOM

## [2.4.2] - 2026-05-25

### Changed
- migrate block-editor iframe styles to canonical enqueue_block_assets

## [2.4.1] - 2026-05-24

### Fixed
- opt Gutenberg block-preview iframes out of responsive max-width
...
### Fixed
- Fix editor styles leaking onto wp-admin page
...
### Changed
- Update @extrachill/tokens to 0.5.0, add Queens location badge
...
### Changed
- remove implicit content gutters from theme
...
### Fixed
- let archive cards use shared edge surfaces
...
### Changed
- add page chrome primitive

## [2.2.9] - 2026-03-26

### Changed
- introduce mobile edge surface primitive

## [2.2.8] - 2026-03-26

### Changed
- centralize mobile card surface rules
...
### Changed
- Keep page mobile width override without card styling

## [2.2.3] - 2026-03-25

### Changed
- Keep page breadcrumbs outside the content card

## [2.2.2] - 2026-03-25

### Changed
- Apply single-post content shell rules to pages
