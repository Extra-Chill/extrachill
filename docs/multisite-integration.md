...
ExtraChill theme serves **all 9 active sites** in the WordPress multisite network (Blog ID 6 unused; docs.extrachill.com at Blog ID 10; horoscope.extrachill.com planned for future Blog ID 11):
